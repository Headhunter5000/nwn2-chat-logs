...
export const COLOR_START_TAG = /<color=([^>]+)>/g;
export const COLOR_START_TAG_SPEECH = /<color=white>/g;
export const COLOR_START_TAG_EMOTE = /<color=lightgreen>/g;
export const STAR = /\*/g;
export const STAR_SECTION = /<color[^>]*>\*<\/color>([^*]+)(?:<color[^>]*>\*<\/color>|$)/g;
