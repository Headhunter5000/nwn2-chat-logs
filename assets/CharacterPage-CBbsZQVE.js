import{a as e}from"./rolldown-runtime-DYb3wWwV.js";import{o as t,s,t as a,u as r}from"./react-core-n8f4OU8y.js";import{B as o,D as n,E as i,H as c,I as l,L as m,O as d,T as u,U as p,V as g,b as h,k as f,l as x,w as y}from"./vendor-grommet-lAUS5eR6.js";import{t as j}from"./vendor-react-i18next-vfdcZHfu.js";import{_ as k,a as b,c as v,d as $,h as C,l as z,u as T,v as S}from"./index-B2AfyKZN.js";import{t as D}from"./navigation-DrSIweUB.js";import{n as w,t as M}from"./MessageText-B20i4-Qt.js";var I=e(r());f();var N=e=>e?.split("T")[0],E=e=>new Date(e).toISOString();p();var F=a(),O=e=>{e.preventDefault(),e.stopPropagation()},W=c(({className:e,day:t,isSelected:s=!1,isMarked:a=!1,onClick:r})=>(0,F.jsx)("div",{className:e,onClick:!s&&a?r:O,"data-testid":`calendar-day-${t}`,"data-is-selected":s,"data-is-marked":a,children:t}))(({theme:e,size:t="medium"})=>{const s=C(`calendar.${t}.daySize`)({theme:e});return g`
    display: flex;
    justify-content: center;
    align-items: center;
    width: ${s};
    height: ${s};
  `}),A=({dates:e,size:t,onClick:s})=>({date:a,day:r,...o})=>{const n=!!e?.find(e=>N(E(a))===e);return(0,F.jsx)(W,{...o,day:r,size:t,isMarked:n,onClick:s})},B=({char:e,currentDate:s,size:a="medium"})=>{const r=t(),{statsByChar:o}=(0,I.useContext)(k),[c,m]=(0,I.useState)(!1),[d,u]=(0,I.useState)(null),{dates:p,firstDate:g,lastDate:f}=(0,I.useMemo)(()=>o[e]??{},[e,o]),x=(0,I.useCallback)(()=>m(!0),[]),j=(0,I.useCallback)(()=>m(!1),[]);return(0,F.jsxs)(F.Fragment,{children:[(0,F.jsx)(n,{ref:u,alignSelf:"start",children:(0,F.jsx)(y,{label:s,icon:(0,F.jsx)(l,{size:20}),onClick:x})}),c&&d&&(0,F.jsx)(i,{target:d,onClickOutside:j,onEsc:j,stretch:!1,children:(0,F.jsx)(h,{size:a,margin:a,animate:!1,daysOfWeek:!0,firstDayOfWeek:1,bounds:[g,f],date:E(s),onSelect:t=>r(D(e,N(Array.isArray(t)?t[0]:t))),children:A({dates:p,size:a,onClick:j})})})]})};p();var L=o`
  .message-type-dialog {
    color: #777;
  }
